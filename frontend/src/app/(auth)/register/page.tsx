...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.SyntheticEvent) => {
    ...
    try {
      ...
      await fetchAPI("/api/v1/users/register", {
        method: "POST",
        body: JSON.stringify({ name, email, password }),
      });

      
      const loginData = await fetchAPI("/api/v1/users/login", {
        method: "POST",
        ...
        <div className="flex flex-col w-full h-full items-center justify-center pb-16">
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl text-gray-900 mb-2 font-bold tracking-tight">Create an Account</h1>
              <p className="text-base text-gray-500">Join StartGauge to validate your idea</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-xl relative overflow-hidden group">
              ...
              <form onSubmit={handleRegister} className="space-y-6">
                <div>
                  <label className="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wider" htmlFor="fullName">Name</label>
              ...
              <div className="mt-8 text-center border-t border-gray-100 pt-6">
                <p className="text-sm text-gray-500">
                  ...
                  <Link href="/login" className="text-purple-700 hover:text-purple-800 transition-colors font-medium ml-1 hover:underline underline-offset-4 decoration-purple-700/30">
                    Log in
                  </Link>
                </p>
              </div>
